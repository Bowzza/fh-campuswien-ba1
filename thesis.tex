...
\section{Angular}
Allgemeine Beschreibung von Angular
\subsection{Architektur}
\subsection{Components}
\subsection{Lifecycle}
\subsection{Typescript}
\section{Vue.js}
Allgemeine Beschreibung von Vue.js
\subsection{Architektur}
\subsection{Components}
\subsection{Lifecycle}
...
\section{Methodik}
\subsection{Angular}
Wie hat man folgende Kriterien festgestellt bzw. gemessen
\subsubsection{Development Speed}
\subsubsection{Build Size}
...
\section{Vergleich}
Vergleiche der Kriterien beschreiben
